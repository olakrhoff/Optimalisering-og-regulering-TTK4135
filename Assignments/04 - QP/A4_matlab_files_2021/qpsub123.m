function [X,lambda,exitflag,output,how]=qpsub123(H,f,A,B,lb,ub,X,neqcstr,verbosity,caller,ncstr,numberOfVariables,options)
...
if mc>eps
   ...
   quiet = -2;
   [XS,lambdaS,exitflagS,outputS] = qpsub123([],[zeros(numberOfVariables,1);1],A2,[B;1e-5], ...
