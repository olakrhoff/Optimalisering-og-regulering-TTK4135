  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.RateTransition_Buffer
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 70;
	
	  ;% helicopter_DW.RateTransition1_Buffer
	  section.data(15).logicalSrcIdx = 14;
  ...
  targMap.checksum0 = 992284180;
  targMap.checksum1 = 2384595788;
  targMap.checksum2 = 2479350970;
  targMap.checksum3 = 4153162769;
