  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% helicopter_B.Gain1_g
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 21;
	
	  ;% helicopter_B.elev_ref
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.Scope_PWORK_c.LoggedData
	  section.data(18).logicalSrcIdx = 32;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helicopter_DW.Scope1_PWORK_c.LoggedData
	  section.data(19).logicalSrcIdx = 33;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_DW.Scope2_PWORK_a.LoggedData
	  section.data(20).logicalSrcIdx = 34;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_DW.ToFile_PWORK_e.FilePtr
	  ...
	  ;% helicopter_DW.ToFile_IWORK_j.Count
  ...
  targMap.checksum0 = 3184592147;
  targMap.checksum1 = 2081142745;
  targMap.checksum2 = 4223715458;
  targMap.checksum3 = 2053704134;
