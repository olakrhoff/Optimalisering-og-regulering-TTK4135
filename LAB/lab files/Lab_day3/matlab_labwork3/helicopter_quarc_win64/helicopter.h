...
typedef struct {
  ...
  real_T FromWorkspace1[4];            /* '<S8>/From Workspace1' */
  real_T TravelCounttorad;             /* '<S7>/Travel: Count to rad' */
  real_T Gain;                         /* '<S16>/Gain' */
  real_T travel;                       /* '<Root>/Sum4' */
  real_T Gain_d;                       /* '<S17>/Gain' */
  real_T PitchCounttorad;              /* '<S7>/Pitch: Count to rad' */
  real_T Gain_i;                       /* '<S13>/Gain' */
  real_T Gain_b;                       /* '<S14>/Gain' */
  real_T Gain1[4];                     /* '<S5>/Gain1' */
  real_T delta_x[4];                   /* '<S8>/Sum' */
  real_T Sum1;                         /* '<S8>/Sum1' */
  real_T Gain1_g;                      /* '<S3>/Gain1' */
  real_T elev_ref;                     /* '<Root>/elevation_ref' */
  real_T ElevationCounttorad;          /* '<S7>/Elevation: Count to rad' */
  real_T Gain_e;                       /* '<S11>/Gain' */
  real_T elev;                         /* '<Root>/Sum' */
  real_T Gain1_p;                      /* '<S4>/Gain1' */
  real_T Gain_dg;                      /* '<S12>/Gain' */
  real_T Gain1_e[6];                   /* '<S2>/Gain1' */
  real_T Gain_l;                       /* '<S15>/Gain' */
  real_T BackmotorSaturation;          /* '<S7>/Back motor: Saturation' */
  real_T FrontmotorSaturation;         /* '<S7>/Front motor: Saturation' */
  real_T In1;                          /* '<S10>/In1' */
} B_helicopter_T;
...
typedef struct {
  ...
  real_T HILWriteAnalog_Buffer[2];     /* '<S7>/HIL Write Analog' */
  ...
  struct {
    void *LoggedData;
  } ElevationScopedegs_PWORK;          /* '<S7>/Elevation: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } ElevationScopedeg_PWORK;           /* '<S7>/Elevation: Scope [deg]' */

  struct {
    void *LoggedData;
  } PitchScopedeg_PWORK;               /* '<S7>/Pitch: Scope [deg]' */

  struct {
    void *LoggedData;
  } PtichrateScopedegs_PWORK;          /* '<S7>/Ptich rate: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } PtichrateScopedegs1_PWORK;         /* '<S7>/Ptich rate: Scope [deg//s]1' */

  struct {
    void *LoggedData;
  } TravelrateScopedegs_PWORK;         /* '<S7>/Travel rate: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } TravelScopedeg_PWORK;              /* '<S7>/Travel: Scope [deg]' */

  struct {
    void *LoggedData;
  } Backmotor_PWORK;                   /* '<S7>/Back motor' */

  struct {
    void *LoggedData;
  } Frontmotor_PWORK;                  /* '<S7>/Front motor' */

  void *HILWriteAnalog_PWORK;          /* '<S7>/HIL Write Analog' */
  struct {
    void *LoggedData;
  } Scope_PWORK_c;                     /* '<S8>/Scope' */
  ...
  struct {
    void *LoggedData;
  } Scope2_PWORK_a;                    /* '<S8>/Scope2' */

  struct {
    void *FilePtr;
  } ToFile_PWORK_e;                    /* '<S8>/To File' */
...
typedef struct {
  real_T TravelTransferFcn_CSTATE;     /* '<S7>/Travel: Transfer Fcn' */
  real_T PitchTransferFcn_CSTATE;      /* '<S7>/Pitch: Transfer Fcn' */
  real_T ElevationTransferFcn_CSTATE;  /* '<S7>/Elevation: Transfer Fcn' */
...
/* State disabled  */
typedef struct {
  boolean_T TravelTransferFcn_CSTATE;  /* '<S7>/Travel: Transfer Fcn' */
  boolean_T PitchTransferFcn_CSTATE;   /* '<S7>/Pitch: Transfer Fcn' */
  boolean_T ElevationTransferFcn_CSTATE;/* '<S7>/Elevation: Transfer Fcn' */
...
struct P_helicopter_T_ {
  ...
  real_T K_pd;                         /* Variable: K_pd
                                        * Referenced by: '<S9>/K_pd'
                                        */
  real_T K_pp;                         /* Variable: K_pp
                                        * Referenced by: '<S9>/K_pp'
                                        */
  ...
  real_T elevation_gain;               /* Variable: elevation_gain
                                        * Referenced by: '<S7>/Elevation_gain'
                                        */
  real_T travel_gain;                  /* Variable: travel_gain
                                        * Referenced by: '<S7>/Travel_gain'
                                        */
 ...
 * '<S3>'   : 'helicopter/Degrees to Radians1'
 * '<S4>'   : 'helicopter/Degrees to Radians2'
 * '<S5>'   : 'helicopter/Degrees to Radians3'
 * '<S6>'   : 'helicopter/Elevation controller'
 * '<S7>'   : 'helicopter/Helicopter_interface'
 * '<S8>'   : 'helicopter/LQR'
 * '<S9>'   : 'helicopter/Pitch controller'
 * '<S10>'  : 'helicopter/Elevation controller/If Action Subsystem'
 * '<S11>'  : 'helicopter/Helicopter_interface/Elevation rad to deg'
 * '<S12>'  : 'helicopter/Helicopter_interface/Elevation rate rad to deg'
 * '<S13>'  : 'helicopter/Helicopter_interface/Pitch rad to deg'
 * '<S14>'  : 'helicopter/Helicopter_interface/Pitch rate rad to deg'
 * '<S15>'  : 'helicopter/Helicopter_interface/Pitch rate rad to deg1'
 * '<S16>'  : 'helicopter/Helicopter_interface/Travel rad to deg'
 * '<S17>'  : 'helicopter/Helicopter_interface/Travel rate  rad to deg'
 */
