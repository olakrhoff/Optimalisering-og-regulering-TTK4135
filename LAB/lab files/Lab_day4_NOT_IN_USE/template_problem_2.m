...
tic
[z,lambda] = fmincon(Q, [], [], [], Aeq, beq, vlb, vub, nonlcon); % hint: quadprog. Type 'doc quadprog' for more info 
t1=toc;
...
function [c,ceq] = elevation_con(x)
    c = alfa*exp(-beta*(x(1)-lambda_t)^2)-x(5);
    c
    ceq = [];
end
