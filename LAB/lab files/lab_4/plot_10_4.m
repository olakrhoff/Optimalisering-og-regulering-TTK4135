load('Time.mat')
load('observed_10_4.mat')
x1m = observed_10_4(2,:);              % State x1 from solution
x2m = observed_10_4(3,:);              % State x2 from solution
x3m = observed_10_4(4,:);              % State x3 from solution
x4m = observed_10_4(5,:);              % State x4 from solution
x5m = observed_10_4(6,:);              % State x5 from solution
x6m = observed_10_4(7,:);              % State x6 from solution
...
x1m_lqr = observed_10_4(2,:);              % State x1 from solution
x2m_lqr = observed_10_4(3,:);              % State x2 from solution
x3m_lqr = observed_10_4(4,:);              % State x3 from solution
x4m_lqr = observed_10_4(5,:);              % State x4 from solution
x5m_lqr = observed_10_4(6,:);              % State x5 from solution
x6m_lqr = observed_10_4(7,:);              % State x6 from solution
...
figure();
plot(t(20:end),x5(20:end),'r',Time(1,2400:end), x5m_lqr(2400:end), 'b',Time, x5m, '--g','LineWidth', 2); grid on;
legend('e^*','e')
axis([5 20 -0.05 0.2])

figure();
plot(t(20:end),x6(20:end),'r',Time(1,2400:end), x6m_lqr(2400:end),'b', 'LineWidth', 2); grid on;
legend('e_{dot}^*','e_{dot}');
axis([5 20 -0.16 0.16])